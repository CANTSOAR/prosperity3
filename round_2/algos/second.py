...
class Trader:
    ...
    def compute_orders_basket_1(self, PRODUCT, order_depth):
        ...
        if len(spread) > lookback:
            ...
            long_entry = z_score > z_score_burst_thresh or (z_score > -z_score_reversal_thresh and prev_z_score < -z_score_reversal_thresh)
            short_entry = z_score < -z_score_burst_thresh or (z_score < z_score_reversal_thresh and prev_z_score > z_score_reversal_thresh)

            exit = z_score * prev_z_score <= 0
